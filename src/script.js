(()=>{
    ...
    function toggleSidebar(e){
        ...
        document.getogglementById('sidebar').classList.toggle('active');
        document.getElementById('sidebar-overlay').classList.toggle('overlay--show');
    }

    toggleButtons.forEach(function(toggleButton){toggleButton.addEventListener('click,toggleSidebar')})
})();